  ...
  return (
    <>
      <div className="content-headerPage">
        ...
        <header>
          <h3>
            Encontre seu futuro melhor amigo aqui! Os animais que cuidamos na
            UFC precisam de uma nova casa e mal podem esperar para se juntar a
            você. Tenha uma nova experiência cheia de amor e carinho.
          </h3>
        </header>
      </div>
